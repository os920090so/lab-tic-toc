...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__banner_js__ = __webpack_require__(330);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__grid_js__ = __webpack_require__(331);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reset_js__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_css__ = __webpack_require__(333);
...
var Main = function (_Component) {
  ...
  function Main(root) {
    ...
    _this.banner = new __WEBPACK_IMPORTED_MODULE_1__banner_js__["a" /* default */](root.querySelector(__WEBPACK_IMPORTED_MODULE_1__banner_js__["a" /* default */].getRootClass()));
    _this.banner.on('rolechange', _this.handleroleclick.bind(_this));

    _this.grid = new __WEBPACK_IMPORTED_MODULE_2__grid_js__["a" /* default */](root.querySelector('.grid'));
    _this.grid.on('changeTurn', _this.handleGridClick.bind(_this));
    _this.grid.on('someoneWin', _this.handleSomeoneWin.bind(_this));

    _this.reset = new __WEBPACK_IMPORTED_MODULE_3__reset_js__["a" /* default */](root.querySelector('.reset'));
    _this.reset.on('resetclick', _this.handleResetClick.bind(_this));
  ...
  _createClass(Main, [{
    key: 'handleGridClick',
    value: function handleGridClick(firer, turn) {
      this.banner.changeTurn(turn);
    }
  }, {
    key: 'handleSomeoneWin',
    value: function handleSomeoneWin(firer, turn) {
      console.log(turn);
      this.banner.someoneWin(turn);
    }
  }, {
    key: 'handleroleclick',
    value: function handleroleclick(firer, turn) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_js__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__turn_js__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__banner_css__ = __webpack_require__(338);
...
var Banner = function (_Component) {
  ...
  function Banner(root) {
    ...
    _this.roles = [];
    _this.first = false;
    _this.turn = new __WEBPACK_IMPORTED_MODULE_2__turn_js__["a" /* default */](root.querySelector(__WEBPACK_IMPORTED_MODULE_2__turn_js__["a" /* default */].getRootClass()));
    var els = root.querySelectorAll(__WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */].getRootClass());
    ...
    try {
      for (var _iterator = els[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var role = new __WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */](el);
        role.on('roleclick', _this.handleroleclick.bind(_this));
        if (el.textContent === 'X') role.choosethis();
    ...
    _this.turn.showturn(_this.first);
    return _this;
  }
  ...
  _createClass(Banner, [{
    ...
    value: function changeTurn(turn) {
      ...
      if (!this.first) this.roles[0].choosethis();else this.roles[1].choosethis();
      this.turn.showturn(this.first);
    }
  }, {
    key: 'someoneWin',
    value: function someoneWin(turn) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_js__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__grid_css__ = __webpack_require__(345);
...
var Grid = function (_Component) {
  ...
  function Grid(root) {
    ...
    while (number < els.length) {
      var cell = new __WEBPACK_IMPORTED_MODULE_1__cell_js__["a" /* default */](els[number], number + 1);
      cell.on('cclick', _this.handleCellClick.bind(_this));
  ...
  _createClass(Grid, [{
    ...
    key: 'handleCellClick',
    value: function handleCellClick(firer, number) {
      if (this.gameover) return;else {
        if (this.turn) {
          firer.writeCircle();
          this.state[number] = 1;
        } else {
    ...
    key: 'testequal',
    value: function testequal(a, b, c) {
      if (a < 0 || b < 0 || c < 0) return false;else if (a === b && a === c && b === c) return true;else return false;
    }
  }, {
    key: 'checkwin',
    value: function checkwin() {
      if (this.testequal(this.state[1], this.state[2], this.state[3]) || this.testequal(this.state[4], this.state[5], this.state[6]) || this.testequal(this.state[7], this.state[8], this.state[9]) || this.testequal(this.state[1], this.state[4], this.state[7]) || this.testequal(this.state[2], this.state[5], this.state[8]) || this.testequal(this.state[3], this.state[6], this.state[9]) || this.testequal(this.state[1], this.state[5], this.state[9]) || this.testequal(this.state[3], this.state[5], this.state[7])) this.fire('someoneWin', !this.turn);
    }
  }]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reset_css__ = __webpack_require__(347);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_css__ = __webpack_require__(342);
...
var Role = function (_Component) {
  ...
  _createClass(Role, [{
    ...
    key: 'handleDomClick',
    value: function handleDomClick() {
      if (this.root.textContent === 'X') this.fire('roleclick', false);else this.fire('roleclick', true);
    }
  }]);
...
var Turn = function (_Component) {
  ...
  _createClass(Turn, [{
    ...
    key: 'showwin',
    value: function showwin(who) {
      if (who) this.root.textContent = ' O win';else this.root.textContent = ' X win';
    }
  }]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(329);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_css__ = __webpack_require__(349);
...
var Cell = function (_Component) {
    ...
    _createClass(Cell, [{
        ...
        key: 'handleDomClick',
        value: function handleDomClick() {
            if (this.beclicked) return;
            this.fire('cclick', this.num);
            this.beclicked = true;
        }
    }, {
        key: 'writeCircle',
        value: function writeCircle() {
            this.root.textContent = 'O';
        }
    }, {
        key: 'writeX',
        value: function writeX() {
